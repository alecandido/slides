...
\begin{frame}{Concepts}
    ...
    \begin{columns}
        ...
        \begin{column}{0.4\textwidth}
            \vcinclude{numpy}{height=50pt} {\Huge $\qquad\to\qquad$} N-dim array
            \vspace*{10pt}

            \vcinclude{pandas}{height=50pt} {\Huge $\qquad\to\qquad$} Table
        \end{column}
        \begin{column}{0.4\textwidth}
            \vcinclude{xarray}{height=50pt} {\Huge $\qquad\to\qquad$} Dataset
            \vspace*{10pt}
...
\begin{frame}{Building Blocks}
    \begin{columns}
        \begin{column}{0.5\textwidth}
            ...
            \begin{figure}
                \centering
                \includegraphics[width=0.3\textwidth]{duck}
            \end{figure}
