...
\titlegraphic{\centering
  	...
  	\hfill
	\includegraphics[height=.5cm]{infn_logo.png}
	\includegraphics[height=.5cm]{unimi_logo.png}
	
	\vfill\vspace*{205pt}
	\raisebox{3pt}[0pt][0pt]{\includegraphics[height=.3cm]{nnpdf_logo_official.pdf}}
	\includegraphics[height=.5cm]{n3pdf_logo.png}
	\includegraphics[height=.5cm]{erc_logo.png}
	\includegraphics[height=.5cm]{800px-Flag_of_Europe.svg.png}
}
...
\begin{frame}{Intrinsic Charm: LHCb and Significance}
	\begin{center}
		...
		\quad%
		\visible<2->{\includegraphics[width=.47\linewidth]{pull_baseline_EMC_LHCb_Zc.pdf}}
	\end{center}
